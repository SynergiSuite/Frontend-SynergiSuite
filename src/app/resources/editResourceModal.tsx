...
type EditResourceModalProps = {
  ...
  onClose: () => void;
  onSave: (id: string, payload: Omit<ResourceType, "id">) => Promise<void>;
};
...
export default function EditResourceModal({
  ...
  const [status, setStatus] = useState<"Available" | "Allocated" | "Under Maintenance">(resource.status);
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="text-[10px] uppercase tracking-wider font-semibold text-white/30 mt-1">
                Modify details for {resource.name || "resource item"}
              </p>
            </div>
            <button
              type="button"
